<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $sqlDelete = "DELETE FROM sqlcommunity_interaction.post WHERE id = $post_id";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                        ...
                        <a href="pending.php" class="nav-item nav-link active">
                                        ...
                                        while($getData = mysqli_fetch_assoc($queryGetInfo)) {
                                            ...
                                            <div class="post-item">
                                              ...
                                              <div class="actions" style = "display: flex; ">
                                                 ...
                                                 <button class="comment-button btn btn-danger" style="color: white;" data-bs-toggle="modal" data-bs-target="#commentModal<?php echo $postId; ?>">
                                                    Delete Post
                                                </button>

                                                <form action="pending.php" method = "post">
                                                    <div class="modal fade" id="commentModal<?php echo $postId; ?>" tabindex="-1" aria-labelledby="commentModalLabel<?php echo $postId; ?>" aria-hidden="true" style = "margin-top: 10%;">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header" style="background-color: #AE445A;">
                                                                ...
                                                                <div class="modal-body" style = "color: grey;">
                                                                    ...
                                                                    <input type = "number" name = "post_id" value = "<?php echo $getData['id']; ?>" hidden>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close" style="border-radius: 20px;">Close</button>
                                                                    <input type="submit" name="commentForm" value="Confirm Deletion" class="btn btn-success" style="border-radius: 20px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
