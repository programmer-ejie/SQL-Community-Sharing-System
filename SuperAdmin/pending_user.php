    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="pending_admin.php" class="nav-item nav-link">
                <i class="fa fa-hourglass-half me-2"></i>Pending Admin 
                </a>
                <a href="pending_user.php" class="nav-item nav-link active">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <?php
                                $sqlGetSchool = "SELECT * FROM sqlcommunity_main.user_account WHERE status = 'Pending'";
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="button" class="btn btn-success" href="action/pending_user_A.php?id=<?php echo $getData['id']; ?>">Confirm Approve</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="<?php echo $uniqueDeleteModalId; ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?php echo $getData['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                                                        <a type="button" class="btn btn-success" href="action/pending_user_D.php?id=<?php echo $getData['id']; ?>">Confirm Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
