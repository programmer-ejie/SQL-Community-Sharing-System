    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="approve_admin.php" class="nav-item nav-link active">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <?php
                                $sqlGetSchool = "SELECT * FROM sqlcommunity_main.admin_account WHERE status = 'Approve'";
                            ...
                            <tr class="school-row text-center">
                                ...
                                <td class="school-name"><h6 style="color: grey; margin-top: 7px; background-color: green; padding-top: 2px; padding-bottom: 2px; border-radius: 10px; color: white;"><?php echo $getData['status'].'d'; ?></h6></td>
